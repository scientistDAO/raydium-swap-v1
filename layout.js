...
var { bits, Blob, Layout, u32, UInt } = require('buffer-layout');
...
exports.zeros = function zeros(length) {
...
exports.publicKeyLayout = function publicKeyLayout(property) {
...
exports.u64 = function u64(property) {
  return new BNLayout(8, property);
}

exports.u128 = function u128(property) {
...
exports.VersionedLayout = class VersionedLayout extends Layout {
...
exports.sideLayout =  function sideLayout(property) {
  return new EnumLayout({ buy: 0, sell: 1 }, 4, property);
}

exports.orderTypeLayout =  function orderTypeLayout(property) {
  return new EnumLayout({ limit: 0, ioc: 1, postOnly: 2 }, 4, property);
}

exports.selfTradeBehaviorLayout =  function selfTradeBehaviorLayout(property) {
...
exports.accountFlagsLayout = function accountFlagsLayout(property = 'accountFlags') {
  return ACCOUNT_FLAGS_LAYOUT.replicate(property);
}

exports.setLayoutDecoder = function setLayoutDecoder(layout, decoder) {
...
exports.setLayoutEncoder = function setLayoutEncoder(layout, encoder) {
